## this is for imputation method: mixed-effect model approach + mi ##
...
for (f in train_files){
  ...
  data_train <- data_train %>%
    mutate(CAT_lumens_Total_missing = if_else(if_any(c(CAT_lumens_CVC_missing, CAT_lumens_PICC_missing, CAT_lumens_Tunneled_CVC_missing), ~ . == 1), 1, 0))
  ...
  data_train_bin <- impute_missing_values(data_train_bin, data_train_bin, "CARE_NEU_GCS_score_last", c("LM", "CARE_NEU_GCS_score_last_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_train_bin <- impute_missing_values(data_train_bin, data_train_bin, "CAT_lumens_CVC", c("LM", "CAT_catheter_type_binary_all_CVC", "CAT_lumens_CVC_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_train_bin <- impute_missing_values(data_train_bin, data_train_bin, "CAT_lumens_Tunneled_CVC", c("LM", "CAT_catheter_type_binary_all_Tunneled_CVC", "CAT_lumens_Tunneled_CVC_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_train_bin <- impute_missing_values(data_train_bin, data_train_bin, "CAT_lumens_PICC", c("LM", "CAT_catheter_type_binary_all_PICC", "CAT_lumens_PICC_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_train_bin <- impute_missing_values(data_train_bin, data_train_bin, "LAB_is_neutropenia",  c("LM", "PAT_age", "MED_7d_TPN", "MS_is_ICU_unit", "MED_L2_7d_L01_ANTINEOPLASTIC_AGENTS", "MED_L2_7d_J01_ANTIBACTERIALS_FOR_SYSTEMIC_USE", "LAB_is_neutropenia_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_train_bin <- impute_missing_values(data_train_bin, data_train_bin, "MS_medical_specialty_bin_drop_Cardiac",  c("LM", "PAT_age", "MED_7d_TPN", "MS_is_ICU_unit", "MED_L2_7d_L01_ANTINEOPLASTIC_AGENTS", "MED_L2_7d_J01_ANTIBACTERIALS_FOR_SYSTEMIC_USE", "MS_medical_specialty_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_train_bin <- impute_missing_values(data_train_bin, data_train_bin, "MS_medical_specialty_bin_drop_Traumatology",  c("LM", "PAT_age", "MED_7d_TPN", "MED_L2_7d_L01_ANTINEOPLASTIC_AGENTS", "MED_L2_7d_J01_ANTIBACTERIALS_FOR_SYSTEMIC_USE", "MS_medical_specialty_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_train_bin <- impute_missing_values(data_train_bin, data_train_bin, "MS_medical_specialty_bin_drop_Pediatrics",  c("LM", "PAT_age", "MED_7d_TPN", "MS_is_ICU_unit", "MED_L2_7d_L01_ANTINEOPLASTIC_AGENTS", "MED_L2_7d_J01_ANTIBACTERIALS_FOR_SYSTEMIC_USE", "MS_medical_specialty_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_train_bin <- impute_missing_values(data_train_bin, data_train_bin, "CARE_VS_temperature_max",  c("LM", "PAT_age", "MED_7d_TPN", "MS_is_ICU_unit", "MED_L2_7d_L01_ANTINEOPLASTIC_AGENTS", "MED_L2_7d_J01_ANTIBACTERIALS_FOR_SYSTEMIC_USE", "CARE_VS_temperature_max_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_train_bin <- impute_missing_values(data_train_bin, data_train_bin, "LAB_urea_last_log",  c("LM", "PAT_age", "MED_7d_TPN", "MS_is_ICU_unit", "MED_L2_7d_L01_ANTINEOPLASTIC_AGENTS", "MED_L2_7d_J01_ANTIBACTERIALS_FOR_SYSTEMIC_USE", "LAB_urea_last_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_train_bin <- impute_missing_values(data_train_bin, data_train_bin, "LAB_creatinine_last_log",  c("LM", "PAT_age", "MED_7d_TPN", "MS_is_ICU_unit", "MED_L2_7d_L01_ANTINEOPLASTIC_AGENTS", "MED_L2_7d_J01_ANTIBACTERIALS_FOR_SYSTEMIC_USE", "LAB_creatinine_last_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_train_bin <- impute_missing_values(data_train_bin, data_train_bin, "LAB_bilirubin_last_log",  c("LM", "PAT_age", "MED_7d_TPN", "MS_is_ICU_unit", "MED_L2_7d_L01_ANTINEOPLASTIC_AGENTS", "MED_L2_7d_J01_ANTIBACTERIALS_FOR_SYSTEMIC_USE", "LAB_bilirubin_last_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_train_bin <- impute_missing_values(data_train_bin, data_train_bin, "LAB_ciclosporin_last_log",  c("LM", "PAT_age", "MED_7d_TPN", "MS_is_ICU_unit", "MED_L2_7d_L01_ANTINEOPLASTIC_AGENTS", "MED_L2_7d_J01_ANTIBACTERIALS_FOR_SYSTEMIC_USE", "LAB_ciclosporin_last_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_train_bin <- impute_missing_values(data_train_bin, data_train_bin, "LAB_pH_last",  c("LM", "PAT_age", "MED_7d_TPN", "MS_is_ICU_unit", "MED_L2_7d_L01_ANTINEOPLASTIC_AGENTS", "MED_L2_7d_J01_ANTIBACTERIALS_FOR_SYSTEMIC_USE", "LAB_pH_last_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  
  data_test_bin <- impute_missing_values(data_train_bin, data_test_bin, "CARE_NEU_GCS_score_last", c("LM", "CARE_NEU_GCS_score_last_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_test_bin <- impute_missing_values(data_train_bin, data_test_bin, "CAT_lumens_CVC", c("LM", "CAT_catheter_type_binary_all_CVC", "CAT_lumens_CVC_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_test_bin <- impute_missing_values(data_train_bin, data_test_bin, "CAT_lumens_Tunneled_CVC", c("LM", "CAT_catheter_type_binary_all_Tunneled_CVC", "CAT_lumens_Tunneled_CVC_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_test_bin <- impute_missing_values(data_train_bin, data_test_bin, "CAT_lumens_PICC", c("LM", "CAT_catheter_type_binary_all_PICC", "CAT_lumens_PICC_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_test_bin <- impute_missing_values(data_train_bin, data_test_bin, "LAB_is_neutropenia",  c("LM", "PAT_age", "MED_7d_TPN", "MS_is_ICU_unit", "MED_L2_7d_L01_ANTINEOPLASTIC_AGENTS", "MED_L2_7d_J01_ANTIBACTERIALS_FOR_SYSTEMIC_USE", "LAB_is_neutropenia_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_test_bin <- impute_missing_values(data_train_bin, data_test_bin, "MS_medical_specialty_bin_drop_Cardiac",  c("LM", "PAT_age", "MED_7d_TPN", "MS_is_ICU_unit", "MED_L2_7d_L01_ANTINEOPLASTIC_AGENTS", "MED_L2_7d_J01_ANTIBACTERIALS_FOR_SYSTEMIC_USE", "MS_medical_specialty_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_test_bin <- impute_missing_values(data_train_bin, data_test_bin, "MS_medical_specialty_bin_drop_Traumatology",  c("LM", "PAT_age", "MED_7d_TPN", "MED_L2_7d_L01_ANTINEOPLASTIC_AGENTS", "MED_L2_7d_J01_ANTIBACTERIALS_FOR_SYSTEMIC_USE", "MS_medical_specialty_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_test_bin <- impute_missing_values(data_train_bin, data_test_bin, "MS_medical_specialty_bin_drop_Pediatrics",  c("LM", "PAT_age", "MED_7d_TPN", "MS_is_ICU_unit", "MED_L2_7d_L01_ANTINEOPLASTIC_AGENTS", "MED_L2_7d_J01_ANTIBACTERIALS_FOR_SYSTEMIC_USE", "MS_medical_specialty_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_test_bin <- impute_missing_values(data_train_bin, data_test_bin, "CARE_VS_temperature_max",  c("LM", "PAT_age", "MED_7d_TPN", "MS_is_ICU_unit", "MED_L2_7d_L01_ANTINEOPLASTIC_AGENTS", "MED_L2_7d_J01_ANTIBACTERIALS_FOR_SYSTEMIC_USE", "CARE_VS_temperature_max_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_test_bin <- impute_missing_values(data_train_bin, data_test_bin, "LAB_urea_last_log",  c("LM", "PAT_age", "MED_7d_TPN", "MS_is_ICU_unit", "MED_L2_7d_L01_ANTINEOPLASTIC_AGENTS", "MED_L2_7d_J01_ANTIBACTERIALS_FOR_SYSTEMIC_USE", "LAB_urea_last_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_test_bin <- impute_missing_values(data_train_bin, data_test_bin, "LAB_creatinine_last_log",  c("LM", "PAT_age", "MED_7d_TPN", "MS_is_ICU_unit", "MED_L2_7d_L01_ANTINEOPLASTIC_AGENTS", "MED_L2_7d_J01_ANTIBACTERIALS_FOR_SYSTEMIC_USE", "LAB_creatinine_last_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_test_bin <- impute_missing_values(data_train_bin, data_test_bin, "LAB_bilirubin_last_log",  c("LM", "PAT_age", "MED_7d_TPN", "MS_is_ICU_unit", "MED_L2_7d_L01_ANTINEOPLASTIC_AGENTS", "MED_L2_7d_J01_ANTIBACTERIALS_FOR_SYSTEMIC_USE", "LAB_bilirubin_last_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_test_bin <- impute_missing_values(data_train_bin, data_test_bin, "LAB_ciclosporin_last_log",  c("LM", "PAT_age", "MED_7d_TPN", "MS_is_ICU_unit", "MED_L2_7d_L01_ANTINEOPLASTIC_AGENTS", "MED_L2_7d_J01_ANTIBACTERIALS_FOR_SYSTEMIC_USE", "LAB_ciclosporin_last_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  data_test_bin <- impute_missing_values(data_train_bin, data_test_bin, "LAB_pH_last",  c("LM", "PAT_age", "MED_7d_TPN", "MS_is_ICU_unit", "MED_L2_7d_L01_ANTINEOPLASTIC_AGENTS", "MED_L2_7d_J01_ANTIBACTERIALS_FOR_SYSTEMIC_USE", "LAB_pH_last_missing"), group_var = "id", count_vars, binary_vars, linear_vars)
  ...
  data_train_bin <- data_train_bin %>% 
    filter(LM <= 30) %>% 
    select(predictors_col, vars_id_outcome, c("id", "Tstart"), c("ADM_admission_source_binary_all_Home_missing",
